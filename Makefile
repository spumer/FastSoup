...
lint:  ## Проверка кода (linting)
	...
	$(BIN)black --target-version=py36 --skip-string-normalization --line-length=120 --check $(CODE) tests
...
pretty:  ## Автоформатирование согласно code-style
	...
	$(BIN)black --target-version=py36 --skip-string-normalization --line-length=120 $(CODE) tests
